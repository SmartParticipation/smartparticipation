...
<div id="about-header" class="row">
  ...
  <div class="span2">
    ...
    <nav id="about-pages">
      <ul>
        <li><a <?php if ($node_url == '/about/overview') { echo 'class="active"'; } ?> href="/about/overview" title="Overview">Overview</a></li>
        <li><a <?php if ($node_url == '/about/history') { echo 'class="active"'; } ?> href="/about/history" title="History">History</a></li>
