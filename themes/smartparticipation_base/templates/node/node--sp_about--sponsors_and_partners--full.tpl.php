  ...
  <div class="span2">
    ...
    <nav id="about-pages">
      <ul>
        ...
        <li><a class="active" href="/about/sponsors-and-partners" title="Sponsors &amp; Partners">Sponsors &amp; Partners</a></li>
...
<section id="sponsors-and-partners" class="row">
  <div class="span12">

    <?php 
      if (count($content['sponsors_partners'])) {
        foreach ($content['sponsors_partners'] as $sponsor_partner) {
          echo render($sponsor_partner);
        }
      } else {
        ?><p class="no-content"><?php echo t('There are currently no sponsors or partners to display.'); ?></p><?php 
      }
    ?>
