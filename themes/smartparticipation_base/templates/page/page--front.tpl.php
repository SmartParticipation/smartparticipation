...
<div class="container" id="page-container">
  ...
  <?php print drupal_render($content['smartparticipation_core_learn_panel']); ?>

  <?php print drupal_render($content['smartparticipation_core_learn_panel_mobile']); ?>
  
  <?php print drupal_render($content['smartparticipation_core_open_proposals']); ?>


  <?php 
    // NB Use drupal_render() rather than render() so the value of '#printed'
    // is respected.
    print drupal_render($content['smartparticipation_core_coming_soon']);
  ?>
  
  <?php 
    print drupal_render($content['features']);
  ?>

  <?php print drupal_render($content['smartparticipation_core_closed_proposals']); ?>
