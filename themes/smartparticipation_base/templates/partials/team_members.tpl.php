...
<div id="about-header" class="row">
  ...
  <div class="span10">
    ...
    <?php if ( ! empty($team_members['#items']) ) { ?>
      ...
      <div class="carousel-items">
        <div class="rs-carousel module">
          <ul class="rs-carousel-runner">
            <?php foreach ($team_members['#items'] as $item) { ?>
            <li class="rs-carousel-item">
              <h2 class="team-member"><?php print $item['name'];?></h2>
              <p class="bio-team-member"><?php print $item['description'];?></p>
